...
public class UcpEndpoint extends UcxNativeStruct implements Closeable {
     ...
     */
    public UcxRequest closeNonBlockingForce() {
     ...
     */
    public UcxRequest closeNonBlockingFlush() {
    ...
    private static native UcxRequest closeNonBlockingNative(long endpointId, int mode);
}

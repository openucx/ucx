...
- `.agents/skills/ucx-testing/SKILL.md` for choosing and running tests.
- `.agents/skills/ucx-coding/SKILL.md` for source changes and verification.
- `.agents/skills/ucx-pr-review/SKILL.md` for pull-request review.
- `.agents/skills/ucx-api-usage/SKILL.md` for code using UCX public APIs.

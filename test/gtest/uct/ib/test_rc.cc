...
protected:
    ...
    {
        uct_ib_mlx5_md_t *md = ucs_derived_of(m_entity->md(),
                                               uct_ib_mlx5_md_t);
    ...
    void check_enabled(uct_ib_mlx5_dp_ordering_t dp_ordering,
                       uint8_t get_fence_flag)
    {
        EXPECT_EQ(dp_ordering, rc_iface()->config.dp_ordering_devx);
        EXPECT_NE(UCT_RC_FENCE_MODE_NONE,
                  rc_iface()->super.config.fence_mode);
    ...
    {
        EXPECT_EQ(dp_ordering, rc_iface()->config.dp_ordering_devx);
        EXPECT_EQ(UCT_RC_FENCE_MODE_NONE,
                  rc_iface()->super.config.fence_mode);
...
UCS_TEST_P(test_gga_fence_flags, auto_ibta,
...
UCS_TEST_P(test_gga_fence_flags, weak_ibta,
           "GGA_MLX5_AR_ENABLE=auto", "GGA_MLX5_FENCE=weak")
{
    ASSERT_UCS_OK(open_iface(UCT_IB_MLX5_DP_ORDERING_IBTA, false, false));
    check_enabled(UCT_IB_MLX5_DP_ORDERING_IBTA,
                  UCT_IB_MLX5_WQE_CTRL_FLAG_FENCE);
...
UCS_TEST_P(test_gga_fence_flags, none_ibta,
...
UCS_TEST_P(test_gga_fence_flags, auto_relaxed_order,
           "GGA_MLX5_AR_ENABLE=auto", "GGA_MLX5_FENCE=auto")
{
...
UCS_TEST_P(test_gga_fence_flags, auto_pci_atomics,
           "GGA_MLX5_AR_ENABLE=auto", "GGA_MLX5_FENCE=auto")
{

...
protected:
    ...
    void expect_perf_empty_range(PerfPtrType perf, size_t start, size_t end)
    {
                                   ...
                                   const perf_factors_map_t &factors)
    {
        ...
        ASSERT_UCS_OK(ucp_proto_perf_envelope_make(
                &factors_vec.front(), UCS_MASK(factors_vec.size()), start, end,
                0, &envelope));

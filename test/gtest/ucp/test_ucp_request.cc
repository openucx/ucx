...
// THIS TEST CANNOT EXIST WITH CURRENT LOGIC SINCE AFTER RESET WE CANNOT PROCEED
// WITH rndv/get/zcopy SINCE IT DOESN'T HAVE UCP_PROTO_COMMON_INIT_FLAG_RESUME

// IF RNDV/AM IS DISABLED BY RNDV_SCHEME, THERE IS NO PROTO TO CONTINUE OPERATIONS

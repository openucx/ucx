...
void test_ucp_memheap::test_nonblocking_implicit_stream_xfer(nonblocking_send_func_t send, size_t alignment)
{
    ...
    for (int i = 0; i < max_iter; ++i) {
        ...
        (this->*send)(pe0, size, expected_data[i], (void*)((uintptr_t)memheap + alignment + i * size),
                      rkey);
...
void test_ucp_memheap::test_nonblocking_implicit_xfer(nonblocking_send_func_t send, size_t alignment)
{
    ...
    for (int i = 0; i < 300 / ucs::test_time_multiplier(); ++i) {
        ...
        (this->*send)(pe0, size, expected_data, (void*)((uintptr_t)memheap + offset),
                        rkey);

...
UCS_TEST_F(test_string_buffer, expand_range_prefix) {
    ...
    ucs_string_buffer_expand_range(&strb, "prefix[0-2]",
                                   strlen("prefix[0-2]"), ',', SIZE_MAX);
...
UCS_TEST_F(test_string_buffer, expand_range_suffix) {
    ...
    ucs_string_buffer_expand_range(&strb, "[3-5]suffix",
                                   strlen("[3-5]suffix"), ',', SIZE_MAX);
...
UCS_TEST_F(test_string_buffer, expand_range_no_bracket) {
    ...
    ucs_string_buffer_expand_range(&strb, "no_bracket",
                                   strlen("no_bracket"), ',', SIZE_MAX);
...
UCS_TEST_F(test_string_buffer, expand_range_max_elements) {
    ...
    EXPECT_EQ(3ul, ucs_string_buffer_expand_range(&strb, "dev[0-9]",
                                                   strlen("dev[0-9]"), ',',
                                                   3));
...
UCS_TEST_F(test_string_buffer, expand_range_max_elements_one) {
    ...
    EXPECT_EQ(1ul, ucs_string_buffer_expand_range(&strb, "dev[0-9]",
                                                   strlen("dev[0-9]"), ',',
                                                   1));
...
UCS_TEST_F(test_string_buffer, expand_range_max_elements_exceeds_range) {
    ...
    EXPECT_EQ(3ul, ucs_string_buffer_expand_range(&strb, "dev[0-2]",
                                                   strlen("dev[0-2]"), ',',
                                                   100));
    EXPECT_EQ(std::string("dev0,dev1,dev2"), ucs_string_buffer_cstr(&strb));
...
UCS_TEST_F(test_string_buffer, expand_ranges_max_elements_cuts_range) {
    ...
    EXPECT_EQ(3ul, ucs_string_buffer_expand_ranges(&strb, "lo,dev[0-4],eth0",
                                                    ',', 3));
...
UCS_TEST_F(test_string_buffer, expand_ranges_max_elements_across_tokens) {
    ...
    EXPECT_EQ(4ul, ucs_string_buffer_expand_ranges(&strb, "dev[0-2],eth[0-2]",
                                                    ',', 4));
...
UCS_TEST_F(test_string_buffer, expand_ranges_max_elements_exact) {
    ...
    EXPECT_EQ(4ul, ucs_string_buffer_expand_ranges(&strb, "a[0-1],b[0-1]",
                                                    ',', 4));

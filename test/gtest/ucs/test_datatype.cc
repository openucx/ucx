...
UCS_TEST_F(test_datatype, ptr_array_basic) {
    ...
    index = ucs_ptr_array_alloc(&pa, 200);
...
UCS_TEST_F(test_datatype, ptr_array_alloc) {
    ...
    EXPECT_EQ(alloc1, ucs_ptr_array_alloc(&pa, 10));
    EXPECT_EQ(ucs_ptr_array_get_elem_count(&pa), 110);
...
UCS_TEST_F(test_datatype, ptr_array_locked_basic) {
    ...
    index = ucs_ptr_array_locked_alloc(&pa, 200);

...
UCS_TEST_F(test_bitops, is_equal) {
    ...
    check_bitwise_equality(buffer1, buffer2, indices, 159);

    buffer1[19] = 0x10; /* 00010000 */
    check_bitwise_equality(buffer1, buffer2, indices, 130);

    buffer1[16] = 0xff; /* 11111111 */
    check_bitwise_equality(buffer1, buffer2, indices, 128);

    buffer1[9] = 0xff; /* 11111111 */
    check_bitwise_equality(buffer1, buffer2, indices, 65);

    buffer1[7] = 0xff; /* 11111111 */
    check_bitwise_equality(buffer1, buffer2, indices, 8);

    buffer1[1] = 0xff; /* 11111111 */
    check_bitwise_equality(buffer1, buffer2, indices, 8);

    buffer1[0] = 0x1; /* 00000001 */
    check_bitwise_equality(buffer1, buffer2, indices, 1);

    buffer2[0] = 0x1; /* 00000001 */
    check_bitwise_equality(buffer1, buffer2, indices, 8);

    buffer2[0] = 0xff; /* 11111111 */
    check_bitwise_equality(buffer1, buffer2, indices, 0);
}

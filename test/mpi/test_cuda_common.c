...
static CUresult cuCtxCreate_versioned(CUcontext *ctx, CUdevice cu_dev)
{
#if CUDA_VERSION >= 12050
    CUctxCreateParams ctx_create_params = {};
    return cuCtxCreate_v4(ctx, &ctx_create_params, 0, cu_dev);
#else
    return cuCtxCreate(ctx, 0, cu_dev);
#endif
}

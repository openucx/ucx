...
typedef struct ucs_config_parser {
    int          (*read)   (const struct ucs_config_parser *self,
                            const char *buf, void *dest);
    int          (*write)  (const struct ucs_config_parser *self, char *buf,
                            size_t max, const void *src);
    ucs_status_t (*clone)  (const struct ucs_config_parser *self,
                            const void *src, void *dest);
    void         (*release)(const struct ucs_config_parser *self, void *ptr);
    void         (*help)   (const struct ucs_config_parser *self, char *buf,
                            size_t max);
    void         (*doc)    (const struct ucs_config_parser *self,
...
typedef struct ucs_config_allowed_values {
    const void   *values; /**< Pointer to allowed values array */
...
#define UCS_CONFIG_TYPE_UINT_ENUM(allowed_values) {ucs_config_sscanf_uint_enum, ucs_config_sprintf_uint_enum, \
                                                   ucs_config_clone_uint,       ucs_config_release_nop, \
                                                   ucs_config_help_uint_enum,   ucs_config_doc_nop, \
                                                   &UCS_CONFIG_ALLOWED_VALUES_NAME(allowed_values)}

#define UCS_CONFIG_TYPE_BITMAP(allowed_values) {ucs_config_sscanf_bitmap, ucs_config_sprintf_bitmap, \
                                                ucs_config_clone_uint,    ucs_config_release_nop, \

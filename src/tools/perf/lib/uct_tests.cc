...
public:
                                    ...
                                    bool direction_to_responder)
    {
        ...
        ep         = m_perf.uct.peers[peer_index].ep;
        rkey       = m_perf.uct.peers[peer_index].rkey.rkey;
        perf_buffer_init(m_perf.send_buffer, length,
                         m_perf.uct.send_mem.mem_type, ep, rkey);
        perf_buffer_init(m_perf.recv_buffer, length,
                         m_perf.uct.recv_mem.mem_type, ep, rkey);

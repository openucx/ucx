                              ...
                              ucg_group_h *group_p)
{
    ...
    new_group->params.distance = (enum ucg_group_member_distance *)((char*)(new_group
        ...
        ucg_collective_params_t *params, ucg_coll_h *coll)
{
    ...
    ucg_plan_component_t *planc=NULL; // TODO: replace NULL with config value
...
void ucg_worker_groups_cleanup(void *groups_ctx)
{
    ...
    ucg_group_h group=NULL, tmp=NULL;

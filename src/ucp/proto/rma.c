...
#define UCP_RMA_ATOMIC_WITHOUT_RESULT(_ep, _param, _remote_addr, _rkey, _uct_func) \
    { \
        ucs_status_t status; \
        uct_rkey_t uct_rkey; \
        \
...
#define UCP_RMA_ATOMIC_WITH_RESULT(_ep, _params, _remote_addr, _rkey, _result, _uct_func) \
    { \

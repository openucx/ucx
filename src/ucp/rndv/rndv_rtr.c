...
typedef struct {
    ucp_proto_rndv_ctrl_init_params_t     super;
    uct_pack_callback_t                   pack_cb;
    ucp_proto_rndv_rtr_data_received_cb_t data_received;
} ucp_proto_rndv_rtr_init_params_t;
...
static void
ucp_proto_rndv_rtr_common_probe(const ucp_proto_rndv_rtr_init_params_t *params)
{
    ucp_proto_rndv_rtr_priv_t rpriv;
    ucp_proto_caps_t caps;
    ucs_status_t status;

    status = ucp_proto_rndv_ctrl_init(&params->super, &caps, &rpriv.super);
    if (status != UCS_OK) {
        return;
    }

    rpriv.pack_cb       = params->pack_cb;
    rpriv.data_received = params->data_received;
    ucp_proto_common_add_proto(&params->super.super, &caps, &rpriv,
                               sizeof(rpriv));
}
...
static void ucp_proto_rndv_rtr_probe(const ucp_proto_init_params_t *init_params)
{
    ...
    ucp_proto_rndv_rtr_init_params_t params = {
        .super.super.super         = *init_params,
        .super.super.latency       = 0,
        .super.super.overhead      = context->config.ext.proto_overhead_rndv_rtr,
        .super.super.cfg_thresh    = ucp_proto_rndv_cfg_thresh(context,
                                            UCS_BIT(UCP_RNDV_MODE_PUT_ZCOPY) |
                                            UCS_BIT(UCP_RNDV_MODE_AM)),
        .super.super.cfg_priority  = 0,
        .super.super.min_length    = 1,
        .super.super.max_length    = SIZE_MAX,
        .super.super.min_frag_offs = UCP_PROTO_COMMON_OFFSET_INVALID,
        .super.super.max_frag_offs = ucs_offsetof(uct_iface_attr_t,
                                                  cap.am.max_bcopy),
        .super.super.max_iov_offs  = UCP_PROTO_COMMON_OFFSET_INVALID,
        .super.super.hdr_size      = sizeof(ucp_rndv_rtr_hdr_t),
        .super.super.send_op       = UCT_EP_OP_AM_BCOPY,
        .super.super.memtype_op    = UCT_EP_OP_LAST,
        .super.super.flags         = UCP_PROTO_COMMON_INIT_FLAG_RESPONSE |
                                     UCP_PROTO_COMMON_INIT_FLAG_ERR_HANDLING,
        .super.super.exclude_map   = 0,
        .super.remote_op_id        = UCP_OP_ID_RNDV_SEND,
        .super.lane                = ucp_proto_rndv_find_ctrl_lane(init_params),
        .super.unpack_time         = UCS_LINEAR_FUNC_ZERO,
        .super.unpack_perf_node    = NULL,
        .super.perf_bias           = 0.0,
        .super.mem_info.type       = init_params->select_param->mem_type,
        .super.mem_info.sys_dev    = init_params->select_param->sys_dev,
        .super.ctrl_msg_name       = UCP_PROTO_RNDV_RTR_NAME,
        .super.md_map              = 0,
        .pack_cb                   =
                (init_params->select_param->dt_class == UCP_DATATYPE_CONTIG) ?
                ucp_proto_rndv_rtr_pack_with_rkey :
                ucp_proto_rndv_rtr_pack_without_rkey,
        .data_received             = ucp_proto_rndv_rtr_data_received
    };
    ...
    ucp_proto_rndv_rtr_common_probe(&params);
}
...
ucp_proto_rndv_rtr_mtype_probe(const ucp_proto_init_params_t *init_params)
{
    ...
    ucp_proto_rndv_rtr_init_params_t params = {
        ...
        .super.lane                = ucp_proto_rndv_find_ctrl_lane(init_params),
        .super.perf_bias           = 0.0,
        .super.mem_info.type       = UCS_MEMORY_TYPE_HOST,
        .super.mem_info.sys_dev    = UCS_SYS_DEVICE_ID_UNKNOWN,
        .super.ctrl_msg_name       = UCP_PROTO_RNDV_RTR_NAME,
        .pack_cb                   = ucp_proto_rndv_rtr_mtype_pack,
        .data_received             = ucp_proto_rndv_rtr_mtype_data_received
    };
    ...
    status = ucp_proto_init_buffer_copy_time(
            ...
            &params.super.unpack_time, &params.super.unpack_perf_node);
    if (status != UCS_OK) {
        return;
    }
    ...
    params.super.md_map = UCS_BIT(md_index);
    ucp_proto_rndv_rtr_common_probe(&params);

    ucp_proto_perf_node_deref(&params.super.unpack_perf_node);
}

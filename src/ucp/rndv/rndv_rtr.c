...
static size_t ucp_proto_rndv_rtr_pack_with_rkey(void *dest, void *arg)
{
    ...
    ucs_assert(rpriv->super.md_map == dt_iter->type.contig.memh->md_map);
...
static size_t ucp_proto_rndv_rtr_mtype_pack(void *dest, void *arg)
{
    ...
    uct_mem_h uct_memh[UCP_MD_INDEX_BITS];
    ...
    ucs_for_each_bit(md_index, md_map) {
        uct_memh[md_index] = mdesc->memh->uct[md_index];
    }

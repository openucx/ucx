...
/**
 * Arm the lanes of @a lane_map for failover. @a cb is invoked with @a arg once
 * per lane when its failover completes or is aborted, exactly like the discard
 * completion callback of ucp_worker_discard_uct_ep().
 */
ucs_status_t

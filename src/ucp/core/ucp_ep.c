...
{
    ucp_lane_map_t failed_lanes_mask = ucp_ep_get_failed_lanes(ep) |
                                       failed_lanes;
    ucp_lane_index_t lane;
    uct_ep_h uct_ep;

    if (failed_lanes_mask == UCS_MASK(ucp_ep_num_lanes(ep))) {

 ...
 */
enum {
    /* Put and atomic operations on this rkey require remote flush */
    UCP_RKEY_CONFIG_FLAG_FLUSH            = UCS_BIT(0),

    /* Synthetic key used only for protocol performance estimation */

 ...
 */
#define UCP_REQUEST_FLAG_COMPLETED          (UCP_REQUEST_FLAG_LAST << 1)
#define UCP_REQUEST_FLAG_RELEASED           (UCP_REQUEST_FLAG_LAST << 2)
#define UCP_REQUEST_FLAG_EXPECTED           (UCP_REQUEST_FLAG_LAST << 3)
#define UCP_REQUEST_FLAG_LOCAL_COMPLETED    (UCP_REQUEST_FLAG_LAST << 4)
#define UCP_REQUEST_FLAG_REMOTE_COMPLETED   (UCP_REQUEST_FLAG_LAST << 5)
#define UCP_REQUEST_FLAG_SYNC               (UCP_REQUEST_FLAG_LAST << 6)
#define UCP_REQUEST_FLAG_RECV               (UCP_REQUEST_FLAG_LAST << 7)
#define UCP_REQUEST_FLAG_OFFLOADED          (UCP_REQUEST_FLAG_LAST << 8)
#define UCP_REQUEST_FLAG_BLOCK_OFFLOAD      (UCP_REQUEST_FLAG_LAST << 9)
#define UCP_REQUEST_FLAG_STREAM_RECV        (UCP_REQUEST_FLAG_LAST << 10)

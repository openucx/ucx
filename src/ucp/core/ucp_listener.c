...
static ucs_status_t
ucp_listener_query_uct_port(ucp_listener_h listener,
                            ucp_rsc_index_t uct_listener_idx, uint16_t *port_p)
{
    ...
    return ucs_sockaddr_get_port((struct sockaddr *)&attr.sockaddr, port_p);
}

...
/**
 * Memory handles in the registration cache.
 */
typedef struct ucp_mem_rcache_region {
...
static UCS_F_ALWAYS_INLINE void *ucp_memh_address(const ucp_mem_h memh)
{
    ucp_mem_rcache_region_t *region = ucs_container_of(memh,
                                                       ucp_mem_rcache_region_t,
                                                       memh);
    return (void*)region->super.super.start;
}
...
static UCS_F_ALWAYS_INLINE size_t ucp_memh_length(const ucp_mem_h memh)
{
    ucp_mem_rcache_region_t *region = ucs_container_of(memh,
                                                       ucp_mem_rcache_region_t,
                                                       memh);
    return region->super.super.end - region->super.super.start;
}

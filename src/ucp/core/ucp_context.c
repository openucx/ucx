...
static ucs_config_field_t ucp_config_table[] = {
  ...
  {"SOCKADDR_CLOSE_PROTO", "n",
   "Enable synchronized close protocol for sockaddr connected endpoints.\n"
   ...
   ucs_offsetof(ucp_config_t, ctx.sockaddr_proto), UCS_CONFIG_TYPE_BOOL},

...
UCS_PROFILE_FUNC(ucs_status_t, ucp_put_handler, (arg, data, payload, length, am_flags),
...
UCS_PROFILE_FUNC(ucs_status_t, ucp_rma_cmpl_handler, (arg, data, payload, length, am_flags),
                 void *arg, void *data, void *payload, size_t length, unsigned am_flags)
{
...
UCS_PROFILE_FUNC(ucs_status_t, ucp_get_req_handler, (arg, data, payload, length, am_flags),
                 void *arg, void *data, void *payload, size_t length, unsigned am_flags)
{
...
UCS_PROFILE_FUNC(ucs_status_t, ucp_get_rep_handler, (arg, data, payload, length, am_flags),
                 void *arg, void *data, void* payload, size_t length, unsigned am_flags)
{
    ucp_worker_h worker             = arg;

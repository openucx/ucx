 ...
 */
typedef enum {
    UCP_RECV_FLAG_WAITALL = UCS_BIT(0)  /**< This flag requests that operation
                                             will not be completed untill all
                                             amout of requested data is received
                                             and placed in the user buffer. */
} ucp_recv_flags_t;
 ...
 * @param [in]     flags    Flags defined in @ref ucp_recv_flags_t.
 *

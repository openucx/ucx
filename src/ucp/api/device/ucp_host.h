 ...
 *
 * This function returns number of elements in the descriptor mem list handle.
 *
 * @param [in] handle     Descriptors list handle.
 */
size_t ucp_device_get_mem_list_length(const ucp_device_mem_list_handle_h handle_p);

...
static inline void uct_ugni_invoke_orig_comp(uct_ugni_fetch_desc_t *fma)
{
                                   ...
                                   uct_rkey_t rkey, uct_completion_t *comp)
{
    ...
    UCT_TL_IFACE_GET_TX_DESC(&iface->super.super, iface->free_desc, rdma, return UCS_ERR_NO_RESOURCE);
    /* Setup Callback */
                                      ...
                                      uint64_t remote_addr, uct_rkey_t rkey)
{
    ...
    UCT_TL_IFACE_GET_TX_DESC(&iface->super.super, iface->free_desc_famo, fma, return UCS_ERR_NO_RESOURCE);

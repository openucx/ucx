...
#define UCT_TCP_AM_PREPARE(_iface, _ep, _id, _hdr, _pack_f, _am_payload, \
    ...
    do { \
        ...
        \
        ucs_assertv((_ep)->tx.buf == NULL, "ep=%p", _ep); \
        \
...
static inline void uct_tcp_ep_ctx_cleanup(uct_tcp_ep_ctx_t *ctx)
{
                            ...
                            unsigned flags)
{
    ...
    UCT_CHECK_LENGTH_EX(payload_length, 0,

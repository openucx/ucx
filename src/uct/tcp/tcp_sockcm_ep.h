...
typedef enum uct_tcp_sockcm_ep_state {
    ...
    UCT_TCP_SOCKCM_EP_SENDING        = UCS_BIT(4), /* ep started sending data */
    UCT_TCP_SOCKCM_EP_DATA_SENT      = UCS_BIT(5), /* ep completed sending the data */
    UCT_TCP_SOCKCM_EP_DATA_RECEIVING = UCS_BIT(6), /* ep started receiving data */
    UCT_TCP_SOCKCM_EP_DATA_RECVED    = UCS_BIT(7), /* ep completed receiving the data */
    UCT_TCP_SOCKCM_EP_DISCONNECTING  = UCS_BIT(8), /* uct_ep_disconnect was
                                                      called on the ep.
                                                      this ep is not
                                                      necessarily disconnected
                                                      yet */
    UCT_TCP_SOCKCM_EP_FAILED         = UCS_BIT(9)  /* ep is in error state */

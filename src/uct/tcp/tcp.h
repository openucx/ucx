...
enum {
    ...
    /* Operations on the EP were canceled by uct_ep_flush(UCT_FLUSH_FLAG_CANCEL),
     * PUT data which arrives from the peer must not be written anymore */
    UCT_TCP_EP_FLAG_CANCELED           = UCS_BIT(11)
};

...
ucs_config_field_t uct_tcp_sockcm_config_table[] = {
  ...
  {"PRIV_DATA_LEN", "2048",
   ...
   {"ALLOW_ADDR_INUSE", "n",
    "Allow reusing an address that is already in use by another socket.",
    ucs_offsetof(uct_tcp_sockcm_config_t, allow_addr_reuse), UCS_CONFIG_TYPE_BOOL},
                    ...
                    uct_worker_h worker, const uct_cm_config_t *config)
{
    ...
    self->allow_addr_reuse = cm_config->allow_addr_reuse;

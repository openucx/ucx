...
typedef union uct_device_mem_elem uct_device_mem_elem_t;
typedef struct uct_device_local_mem_elem uct_device_local_mem_elem_t;
typedef struct uct_device_remote_tl_elem uct_device_remote_tl_elem_t;
typedef struct uct_device_remote_mem_elem uct_device_remote_mem_elem_t;

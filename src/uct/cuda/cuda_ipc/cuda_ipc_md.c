...
static ucs_config_field_t uct_cuda_ipc_md_config_table[] = {
    {"", "", NULL,  ucs_offsetof(uct_cuda_ipc_md_config_t, super),
...
static ucs_status_t
uct_cuda_ipc_rkey_unpack(uct_md_component_t *mdc, const void *rkey_buffer,
...
static ucs_status_t
uct_cuda_ipc_rkey_release(uct_md_component_t *mdc, uct_rkey_t rkey, void *hndl)
{
    ucs_assert(NULL == hndl);
    ucs_free((void *)rkey);
    return UCS_OK;
}
...
static ucs_status_t uct_cuda_ipc_mem_reg(uct_md_h md, void *addr, size_t length,
...
static ucs_status_t
uct_cuda_ipc_query_md_resources(uct_md_resource_desc_t **resources_p,
...
static ucs_status_t
uct_cuda_ipc_md_open(const char *md_name, const uct_md_config_t *md_config,
                     uct_md_h *md_p)
{

...
#define UCT_CUDA_NVML_FOR_EACH(_macro) \
    ...
    _macro(nvmlDeviceGetHandleByUUID, const char*, nvmlDevice_t*); \
    ...
    _macro(nvmlDeviceGetP2PStatus, nvmlDevice_t, nvmlDevice_t, \
           nvmlGpuP2PCapsIndex_t, nvmlGpuP2PStatus_t*); \

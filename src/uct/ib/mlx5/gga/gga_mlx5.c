...
#define UCT_GGA_MLX5_OPAQUE_MR_LEN  64
#define UCT_GGA_MLX5_OPAQUE_BUF_LEN (UCS_SYS_CACHE_LINE_SIZE + \
                                     UCT_GGA_MLX5_OPAQUE_MR_LEN)
...
uct_gga_mlx5_ep_fence_put(uct_rc_mlx5_iface_common_t *iface,
                          ...
                          uint64_t *addr, uint16_t offset, uint8_t *fm_ce_se)
{
                          ...
                          uct_completion_t *comp)
{
    ...
    UCT_CHECK_LENGTH(uct_iov_total_length(iov, iovcnt), 0, MAX_GGA_MSG_SIZE,
                     "put_zcopy");

...
static UCS_F_ALWAYS_INLINE void
uct_rc_mlx5_txwq_record_psn(uct_rc_mlx5_iface_common_t *iface,
                            ...
                            uint8_t opcode, size_t message_length)
{
    ...
    ucs_assert(txwq->first_psn != NULL);

    txwq->first_psn[wqe_pi & txwq->psn_mask] = txwq->next_psn;
    ...
    txwq->next_psn = (txwq->next_psn + num_packets) & UCS_MASK(24);
}
                             ...
                             uct_ib_log_sge_t *log_sge)
{
    ...
    if (qp_type == IBV_QPT_RC) {
        uct_rc_mlx5_txwq_record_psn(iface, txwq, wqe_pi, opcode,
                                    message_length);
    }

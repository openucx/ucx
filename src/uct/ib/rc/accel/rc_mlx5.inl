                                 ...
                                 uct_rc_txqp_t *txqp, uint16_t hw_ci)
{
    ...
    rc_iface->tx.cq_available += bb_num + rc_iface->tx.cq_free;
    rc_iface->tx.cq_free       = 0;
...
static UCS_F_ALWAYS_INLINE void
uct_rc_mlx5_common_free_tx_res(uct_rc_iface_t *rc_iface, uct_ib_mlx5_txwq_t *txwq,
                               uct_rc_txqp_t *txqp, uint16_t hw_ci)
{
    uint16_t bb_num;

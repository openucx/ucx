...
typedef void (*uct_srd_send_op_completion_t)(uct_srd_send_op_t *send_op,
                                             ucs_status_t status);
...
struct uct_srd_send_op {
    ...
    uct_srd_send_op_completion_t completion; /* Send operation completion */
...
struct uct_srd_send_desc {
    ...
    const uint32_t               lkey;        /* Registration key for this send_desc */
    void                         *unpack_arg;

                                               ...
                                               uct_completion_t *comp)
{
    ...
    uct_dc_mlx5_iface_fill_ravh(&ravh, uct_dc_get_dct_num(iface));
                                    ...
                                    uct_rc_fc_request_t *req)
{
    ...
    if (op == UCT_RC_EP_FC_PURE_GRANT) {
        ...
        sender.global.is_global = dc_ep->flags & UCT_DC_EP_FLAG_GRH;

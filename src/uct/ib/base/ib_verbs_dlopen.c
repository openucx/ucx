...
#define UCT_IB_VERBS_OPS(_op, _void_op, _module, _ops) \
    UCT_IB_VERBS_MANDATORY_OPS(_op, _void_op, _module, _ops) \
    UCT_IB_VERBS_OPTIONAL_OPS(_op, _void_op, _module, _ops)
...
UCT_IB_DLOPEN_DEFINE_MODULE(uct_ib_verbs, UCT_IB_VERBS_LIB_NAME,
                            uct_ib_verbs_ops_t, UCT_IB_VERBS_MANDATORY_OPS,
...
UCT_IB_VERBS_OPTIONAL_OPS(UCT_IB_DLOPEN_FWD_OP, UCT_IB_DLOPEN_FWD_VOID_OP,

...
ucs_config_field_t uct_ib_iface_config_table[] = {
  ...
  {UCT_IFACE_SEND_OVERHEAD_STR, UCT_IB_SEND_OVERHEAD_VALUE(0),
   ...
   0, UCS_CONFIG_TYPE_KEY_VALUE(UCS_CONFIG_TYPE_TIME,
    {UCT_IB_SEND_OVERHEAD_BCOPY, "estimated overhead of allocating a tx buffer",
     ucs_offsetof(uct_ib_iface_config_t, send_overhead.bcopy)},
    {UCT_IB_SEND_OVERHEAD_SQE, "estimated overhead of processing a work request"
                               " completion",
     ucs_offsetof(uct_ib_iface_config_t, send_overhead.cqe)},
    {UCT_IB_SEND_OVERHEAD_DB, "estimated overhead of writing a doorbell to PCI",
     ucs_offsetof(uct_ib_iface_config_t, send_overhead.db)},
    {UCT_IB_SEND_OVERHEAD_WQE_FETCH, "estimated overhead of fetching a wqe",
     ucs_offsetof(uct_ib_iface_config_t, send_overhead.wqe_fetch)},
    {UCT_IB_SEND_OVERHEAD_WQE_POST, "estimated overhead of posting a wqe",

...
typedef struct uct_mm_mapper_ops {
     ...
     * allocated on the same interface. 'buffer' must be at least the size
     * returned from iface_addr_length() */
    ucs_status_t           (*iface_addr_pack)(uct_mm_md_t *md, void *buffer);
